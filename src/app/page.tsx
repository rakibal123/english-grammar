...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-white font-inter">
      {/* Nav */}
      <nav className="sticky top-0 z-50 bg-white/95 backdrop-blur-sm border-b border-[#E8EAEE]">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2.5">
            <div className="w-8 h-8 bg-[#4F46E5] rounded-lg flex items-center justify-center">
              <GraduationCap className="w-5 h-5 text-white" />
            </div>
            <span className="font-bold text-[#0B1C30] text-lg tracking-tight">GrammarFlow</span>
          </Link>
          <div className="hidden md:flex items-center gap-8">
            <Link href="#features" className="text-[#45464D] text-sm hover:text-[#4F46E5] transition-colors">Features</Link>
            <Link href="#curriculum" className="text-[#45464D] text-sm hover:text-[#4F46E5] transition-colors">Curriculum</Link>
          </div>
          <div className="flex items-center gap-3">
            <Link href="/login" className="text-[#45464D] text-sm font-medium hover:text-[#4F46E5] transition-colors hidden md:block">
              Log In
            </Link>
      ...
      <section className="pt-20 pb-24 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-[#EEF2FF] text-[#4F46E5] text-xs font-semibold px-3 py-1.5 rounded-full mb-8">
            <CheckCircle className="w-3.5 h-3.5" />
            No account required. Start as a guest.
          </div>
          <h1 className="text-5xl md:text-6xl font-bold text-[#0B1C30] leading-[1.1] tracking-tight mb-6 text-balance">
            Master English Grammar,<br />
            <span className="text-[#4F46E5]">One Step at a Time.</span>
          </h1>
          <p className="text-[#45464D] text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link href="/learn" className="btn-ghost px-7 py-3 text-base font-medium text-[#45464D]">
              Explore Grammar
            </Link>
          </div>

          {/* Mini preview card */}
          <div className="mt-14 inline-flex items-center gap-3 bg-white border border-[#E8EAEE] rounded-2xl px-5 py-3 shadow-sm">
            <div className="w-8 h-8 bg-green-100 rounded-lg flex items-center justify-center">
              <CheckCircle className="w-4 h-4 text-green-600" />
            </div>
            <div className="text-left">
              <p className="text-[11px] text-[#76777D]">Lesson Completed</p>
              <p className="text-sm font-semibold text-[#0B1C30]">Past Participles <span className="text-[#4F46E5]">+50 XP</span></p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={title} className="card">
                ...
                <h3 className="font-semibold text-[#0B1C30] mb-2">{title}</h3>
                <p className="text-[#76777D] text-sm leading-relaxed">{desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="curriculum" className="py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-[#45464D] text-lg mb-12 max-w-xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            {[
              ...
              <div key={tense} className={`card py-3 px-4 text-sm font-medium text-left ${i === 0 ? 'text-[#4F46E5] border-[#4F46E5]/30' : 'text-[#45464D]'}`}>
                <span className={`inline-block w-2 h-2 rounded-full mr-2 ${i === 0 ? 'bg-[#4F46E5]' : 'bg-[#C6C6CD]'}`} />
                {tense}
              </div>
            ))}
          </div>
      ...
      <section className="py-20 bg-[#0F172A] px-6">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <Link href="/dashboard" className="inline-flex items-center gap-2 bg-[#4F46E5] text-white font-semibold px-8 py-3.5 rounded-xl hover:bg-[#4338CA] transition-colors">
            Start Learning Free
            <ArrowRight className="w-4 h-4" />
          </Link>
        </div>

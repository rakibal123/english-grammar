    ...
    <div className="min-h-screen bg-[var(--bg-color)] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-lighter mt-1">Save your progress and track your journey</p>
        </div>
        ...
        <div className="card">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="text-sm font-medium text-muted block mb-1.5">Username</label>
              <input
                type="text"
                value={form.username}
            ...
            <div>
              <label className="text-sm font-medium text-muted block mb-1.5">Password</label>
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-lighter"
                >

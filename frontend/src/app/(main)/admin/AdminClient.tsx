  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 lg:py-8">
      <div className="mb-8">
        ...
        <p className="text-sm text-lighter">GrammarFlow Content Management</p>
      </div>

      {/* Stats */}
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
        {[
          { label: 'Topics', value: stats?.topicsCount ?? '—', icon: BookOpen, color: 'text-primary', bg: 'bg-[var(--nav-active-bg)]' },
      ...
      <div className="card mb-6">
        ...
        <p className="text-xs text-lighter mt-2">
      ...
      <div className="card">
        ...
        <div className="space-y-2 text-sm text-muted">
          <div className="flex items-center gap-2"><span className="w-2 h-2 bg-primary rounded-full" /> Category: Tenses</div>
